...
// function checkTypes(data: unknown, types: unknown) {
// 	var key;
// 	for (key in data) {
...
// 	return Object.keys(types).reduce((newData, key) => {
...
// 							);
// 				}
// 				return val.map((child) => checkType(child, children));
...
// 							);
// 				}
// 				return Object.keys(val).reduce((newVal, key) => {
