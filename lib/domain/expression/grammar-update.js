...
function peg$parse(input, options) {
  ...
  function peg$f1(args) {
    return new SetSection(args);
  }
  function peg$f2(args) {
  ...
  function peg$f5(path, val) {
    return new SetAction(path, val);
  }
  function peg$f6(path) {
    return new RemoveAction(path);
  }
  function peg$f7(path, val) {
    return new AddAction(path, val);
  }
  function peg$f8(path, val) {
    return new DeleteAction(path, val);
  }
  function peg$f9(val) {    return val  }
  function peg$f10(arg1, arg2) {
    return new ArithmeticOperator('+', arg1, arg2);
  }
  function peg$f11(arg1, arg2) {
    return new ArithmeticOperator('-', arg1, arg2);
  }
  ...
  function peg$parseSetAction() {
    let s0, s1, s2, s3, s4, s5;

    s0 = peg$currPos;
    s1 = peg$parsePathExpressionNode();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
  ...
  function peg$parseRemoveAction() {
    let s0, s1;
  ...
  function peg$parseDeleteAction() {
    let s0, s1, s2, s3;
  ...
  function peg$parseOperand() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parsePathExpressionNode();
      }
    }
  ...
  function peg$parsePathExpressionNode() {
