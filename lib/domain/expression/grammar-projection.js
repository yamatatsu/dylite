...
function peg$parse(input, options) {
  ...
  const peg$e6 = peg$classExpectation([["A", "Z"], "_", ["a", "z"]], false, false, false);
  const peg$e7 = peg$classExpectation([["0", "9"], ["A", "Z"], "_", ["a", "z"]], false, false, false);
  const peg$e8 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false, false);

  function peg$f0(paths) {
    return new ProjectionExpression(paths);
  }
  function peg$f1(head, ix) {
    const index = +(ix.join(''));
    return new ArrayIndexPathSegment(index);
  }
  function peg$f2(head, prop) {
    return prop;
  }
